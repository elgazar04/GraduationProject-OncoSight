        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '32px' }}>
          ...
          <div>
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              {/* 3 Panel View */}
              <ThreePanelView originalImage={scanData.originalImage} segmentationMask={scanData.segmentationMask} diameter={scanData.diameter} hasTumor={scanData.classification !== 'notumor'} />
